...
def upgrade() -> None:
    ...
    op.add_column(
        "tasks", sa.Column("creator_public_id_temp", sa.String(36), nullable=True)
    )
    op.add_column(
        "tasks", sa.Column("assignee_public_id_temp", sa.String(36), nullable=True)
    )
    op.add_column(
        "tasks", sa.Column("family_public_id_temp", sa.String(36), nullable=True)
    )
    op.add_column(
        "users", sa.Column("family_public_id_temp", sa.String(36), nullable=True)
    )
    ...
    op.create_foreign_key(
        "tasks_creator_id_fkey", "tasks", "users", ["creator_id"], ["public_id"]
    )
    op.create_foreign_key(
        "tasks_assignee_id_fkey", "tasks", "users", ["assignee_id"], ["public_id"]
    )
    op.create_foreign_key(
        "tasks_family_id_fkey", "tasks", "families", ["family_id"], ["public_id"]
    )
    op.create_foreign_key(
        "users_family_id_fkey", "users", "families", ["family_id"], ["public_id"]
    )
...
def downgrade() -> None:
    ...
    op.create_foreign_key(
        "tasks_assignee_id_fkey", "tasks", "users", ["assignee_id"], ["id"]
    )
    op.create_foreign_key(
        "tasks_family_id_fkey", "tasks", "families", ["family_id"], ["id"]
    )
    op.create_foreign_key(
        "users_family_id_fkey", "users", "families", ["family_id"], ["id"]
    )
